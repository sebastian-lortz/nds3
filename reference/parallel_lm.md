...
Uses the nds3 algorithmic framework to simulate multiple data sets such
that the resulting correlations and regression coefficients match
specified targets under a given regression model and input parameters.
